...
/***/ "./assets/logoIngest.png":
/*!*******************************!*\
  !*** ./assets/logoIngest.png ***!
  \*******************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/logoIngest.png";
...
Office.onReady(function (info) {
  if (info.host === Office.HostType.Excel) {
    ...
    var downloadEnabled = document.getElementById("download");
    fileInput.addEventListener("change", function () {
      if (fileInput.files && fileInput.files.length > 0) {
        console.log("File selezionato:", fileInput.files[0].name);
        document.getElementById("fileName").textContent = "Selected file: " + fileInput.files[0].name;
        if (fileInput.files.length > 1) {
          for (var no = 1; no < fileInput.files.length; no++) {
...
function fileImport() {
  return _fileImport.apply(this, arguments);
} // Legge il file e divide in righe e in celle
function _fileImport() {
  _fileImport = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var i, downloadEnabled;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 4:
          ...
          // Controlla se il download è abilitato
          downloadEnabled = document.getElementById("download");
          if (downloadEnabled && downloadEnabled.checked) {
            alert("Importazione completata! I file Excel verranno scaricati automaticamente.");
          } else {
...
function _ReadFile() {
  _ReadFile = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(FileSelected) {
    var Reader;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          Reader.onload = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
            var buffer, CSVText, rows, CSVData, _t;
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.p = _context2.n) {
                ...
                case 1:
                  CSVText = new TextDecoder().decode(buffer).trim();
                  if (CSVText) {
                    _context2.n = 2;
                    break;
                  }
                ...
                case 3:
                  CSVData = rows.map(function (row) {
                    var rowForSplitting = row.replace(/"(\d+),(\d+)"/g, "$1.$2");
                    var separator = rowForSplitting.includes(";") ? ";" : ",";
                    return rowForSplitting.split(separator).map(function (cell) {
                      return setCellAs(cell);
                    });
                  });
                  _context2.n = 4;
                  return writeExcel(CSVData);
                case 4:
                  _context2.n = 6;
                  break;
                case 5:
          ...
          Reader.onerror = function () {
            return console.error("Errore lettura file");
          };
        case 1:
...
function SetNumericFormat(CSVData) {
  var colCount = CSVData[0].length;
  var numericCols = Array(colCount).fill(true);
...
function writeExcel(_x2) {
  return _writeExcel.apply(this, arguments);
} // Creazione del file excel vero
// Vengono salvati i file in diversi fogli sullo stesso file excel
function _writeExcel() {
  _writeExcel = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(CSVData) {
    var colCount, i, fixed, overflow;
        ...
        case 1:
          ...
          for (i = 0; i < CSVData.length; i++) {
            if (CSVData[i].length < colCount) {
              ...
              fixed = CSVData[i].slice(0, colCount - 1);
              overflow = CSVData[i].slice(colCount - 1).join(",");
              fixed.push(overflow);
              CSVData[i] = fixed;
            }
          }
          _context4.n = 2;
          return createNewExcel(CSVData);
        case 2:
          return _context4.a(2);
      }
    }, _callee4);
...
function createNewExcel(_x3) {
  return _createNewExcel.apply(this, arguments);
} // Nuova funzione per scaricare un worksheet come workbook separato
function _createNewExcel() {
  _createNewExcel = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(CSVData) {
        ...
        case 0:
          ...
          return Excel.run(/*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(context) {
              var worksheet, CleanName, rowCount, colCount, range, isNumeric, column, headerRange, downloadEnabled;
              return _regenerator().w(function (_context5) {
                while (1) switch (_context5.n) {
                  case 0:
                    ...
                    isNumeric = SetNumericFormat(CSVData);
                  ...
                  case 1:
                    ...
                    _context5.n = 2;
                    return downloadWorksheetAsWorkbook(context, worksheet, CleanName);
                  case 2:
...
function downloadWorksheetAsWorkbook(_x4, _x5, _x6) {
  return _downloadWorksheetAsWorkbook.apply(this, arguments);
}
function _downloadWorksheetAsWorkbook() {
  _downloadWorksheetAsWorkbook = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(context, worksheet, sheetName) {
    var workbook, usedRange, ws, excelFileName, _t2;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          _context7.p = 0;
          workbook = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.book_new();
          usedRange = worksheet.getUsedRange();
          usedRange.load("values");
          _context7.n = 1;
          return context.sync();
        case 1:
          ws = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.aoa_to_sheet(usedRange.values); //array di array -> foglio excel
          xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.book_append_sheet(workbook, ws, sheetName);
          excelFileName = sheetName + ".xlsx"; // Scrivi e scarica il file
          xlsx__WEBPACK_IMPORTED_MODULE_0__.writeFile(workbook, excelFileName);
          console.log("File scaricato: ".concat(excelFileName));
          _context7.n = 3;
          break;
        case 2:
          _context7.p = 2;
          _t2 = _context7.v;
          console.error("Errore durante il download del workbook:", _t2);
        case 3:
...
var ___HTML_LOADER_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../../assets/logoIngest.png */ "./assets/logoIngest.png"), __webpack_require__.b);
// Module
var code = "<!-- Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT License. -->\n<!-- This file shows how to design a first-run page that provides a welcome screen to the user about the features of the add-in. -->\n\n<!DOCTYPE html>\n<html>\n\n<head>\n    <meta charset=\"UTF-8\" />\n    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=Edge\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n    <title>CSV-Excel Converter</title>\n\n    <!-- Office JavaScript API -->\n    <" + "script type=\"text/javascript\" src=\"https://appsforoffice.microsoft.com/lib/1/hosted/office.js\"><" + "/script>\n\n    <!-- For more information on Fluent UI, visit https://developer.microsoft.com/fluentui#/. -->\n    <link rel=\"stylesheet\" href=\"https://res-1.cdn.office.net/files/fabric-cdn-prod_20230815.002/office-ui-fabric-core/11.1.0/css/fabric.min.css\"/>\n\n    <!-- Template styles -->\n    <link href=\"" + ___HTML_LOADER_IMPORT_0___ + "\" rel=\"stylesheet\" type=\"text/css\" />\n</head>\n\n<body class=\"ms-font-m ms-welcome ms-Fabric\">\n    <header class=\"ms-welcome__header ms-bgColor-neutralLighter\">\n        <img width=\"170\" height=\"90\" src=\"" + ___HTML_LOADER_IMPORT_1___ + "\" alt=\"Ingest CSV-Excel Converter\" title=\"CSV-Excel Converter\" />\n        <h1 class=\"ms-font-su\">Welcome</h1>\n        <!-- BOTTONE BROWSE  -->\n        <input type=\"file\" id=\"fileInput\" style=\"display:none\" multiple/>\n        <label for=\"fileInput\" id=\"browse\" class=\"ms-Button ms-Button--hero ms-font-xl\">\n            <span class=\"ms-Button-label\">Select CSV</span>\n        </label>\n\n        <div style=\"display: flex; align-items: center; gap: 5px; margin-top: 10px;\">\n            <input type=\"checkbox\" id=\"download\" checked>\n            <label for=\"download\">Download Enabled</label>\n        </div>\n        <p id=\"fileName\"></p> <!-- Qui apparirà il nome del file selezionato -->\n\n    </header>\n    <section id=\"sideload-msg\" class=\"ms-welcome__main\">\n        <h2 class=\"ms-font-xl\">Please <a target=\"_blank\" href=\"https://learn.microsoft.com/office/dev/add-ins/testing/test-debug-office-add-ins#sideload-an-office-add-in-for-testing\">sideload</a> your add-in to see app body.</h2>\n    </section>\n     <main id=\"app-body\" class=\"ms-welcome__main\" style=\"display: none;\">\n        <h2 class=\"ms-font-xl\">Trascrizione automatica di file CSV</h2>\n        <ul class=\"ms-List ms-welcome__features\">\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">Cosa posso fare?</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <i class=\"ms-Icon ms-Icon--ExcelDocument ms-font-xl\"></i>\n                <span class=\"ms-font-m\">Supporta delimitatori: virgola (,) e punto e virgola (;)</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <i class=\"ms-Icon ms-Icon--NumberField ms-font-xl\"></i>\n                <span class=\"ms-font-m\">Riconoscimento automatico dei numeri decimali</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">Come usare l'add-in CsvToExcel?</span>\n            </li>\n             <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">1. Apri un nuovo file Excel</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">2. Apri l'add-in CsvToExcel</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">3. Premi Importa CSV</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">4. Seleziona uno o più file CSV che vuoi importare e conferma</span>\n            </li>\n            <li class=\"ms-ListItem\">\n                <span class=\"ms-font-m\">5. Premi il bottone Import che trovi in fondo a questa pagina</span>\n            </li>\n        </ul>\n        \n        <!-- BOTTONE RUN -->\n        <button id=\"run\" type=\"button\" class=\"ms-welcome__action ms-Button ms-Button--hero ms-font-xl\">\n            <span class=\"ms-Button-label\">Import</span>\n        </button>\n        <p><label id=\"item-subject\"></label></p>\n    </main>\n\n</body>\n\n</html>";
// Exports
